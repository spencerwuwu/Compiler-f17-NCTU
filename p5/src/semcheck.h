...
void verifyArithmeticOp(struct expr_sem *op1, OPERATOR _operator, struct expr_sem *op2);
void verifyRelOp(struct expr_sem *op1, OPERATOR _operator, struct expr_sem *op2);
void verifyUnaryNot(struct expr_sem *expr);
void verifyAndOrOp(struct expr_sem *op1, OPERATOR _operator, struct expr_sem *op2);
